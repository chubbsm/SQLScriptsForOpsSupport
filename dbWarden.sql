...
**				dbo.sp_Blocking - Created in the Master database
...
IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.DatabaseSettings)
BEGIN
	INSERT INTO [dbWarden].dbo.DatabaseSettings ([DBName], SchemaTracking, LogFileAlerts, LongQueryAlerts, Reindex, HealthReport)
	SELECT name,0,1,1,0,1
	FROM sys.databases
END
GO
...
BEGIN
	...
	SELECT 'LogFiles','MinFileSizeMB','0','Value is percentage',1 UNION ALL	
	SELECT 'TempDB','QueryValue','50','Value is percentage',1 UNION ALL
	SELECT 'TempDB','QueryValue2','20','Value is percentage',1 UNION ALL
	SELECT 'TempDB','MinFileSizeMB','0','Value is a number',1 UNION ALL	
	...
	SELECT 'HealthReport','ShowDatabaseSettings',NULL,'Variable for the HealthReport',1 UNION ALL
	SELECT 'HealthReport','ShowdbWardenSettings',NULL,'Variable for the HealthReport',1 UNION ALL
	...
	SELECT 'HealthReport','ShowEmptySections',NULL,'Variable for the HealthReport',1 UNION ALL
	SELECT 'HealthReport','ShowOrphanedUsers',NULL,'Variable for the HealthReport',1	
END
GO

IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowdbWardenSettings')
BEGIN
	INSERT INTO [dbWarden].dbo.AlertSettings (AlertName,VariableName,Value,[Description],[Enabled])
	SELECT 'HealthReport','ShowdbWardenSettings',NULL,'Variable for the HealthReport',1
END
GO

IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowDatabaseSettings')
BEGIN
	INSERT INTO [dbWarden].dbo.AlertSettings (AlertName,VariableName,Value,[Description],[Enabled])
	SELECT 'HealthReport','ShowDatabaseSettings',NULL,'Variable for the HealthReport',1
END
GO

IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowModifiedServerConfig')
BEGIN
	INSERT INTO [dbWarden].dbo.AlertSettings (AlertName,VariableName,Value,[Description],[Enabled])
	SELECT 'HealthReport','ShowModifiedServerConfig',NULL,'Variable for the HealthReport',1
END
GO

IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowErrorLog')
BEGIN
	INSERT INTO [dbWarden].dbo.AlertSettings (AlertName,VariableName,Value,[Description],[Enabled])
...
IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowLogBackups')
BEGIN
	INSERT INTO [dbWarden].dbo.AlertSettings (AlertName,VariableName,Value,[Description],[Enabled])
	SELECT 'HealthReport','ShowLogBackups',NULL,'Variable for the HealthReport',1
END
GO

IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'LogFiles' AND VariableName = 'MinFileSizeMB')
BEGIN
	INSERT INTO [dbWarden].dbo.AlertSettings (AlertName,VariableName,Value,[Description],[Enabled])
...
IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'TempDB' AND VariableName = 'MinFileSizeMB')
BEGIN
	INSERT INTO [dbWarden].dbo.AlertSettings (AlertName,VariableName,Value,[Description],[Enabled])
...
IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowOrphanedUsers')
BEGIN
	INSERT INTO [dbWarden].dbo.AlertSettings (AlertName,VariableName,Value,[Description],[Enabled])
...
BEGIN
	...
	SELECT @QueryValue = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue' AND AlertName = 'BlockingAlert' AND [Enabled] = 1

	SELECT @QueryValue2 = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue2' AND AlertName = 'BlockingAlert' AND [Enabled] = 1
...
INSERT INTO #TEMP ([DBName], [Status])
SELECT ds.[DBName], 0
	FROM [dbWarden].dbo.DatabaseSettings ds
...
INSERT INTO [dbWarden].dbo.JobStatsHistory (JobName,[Owner],Category,[Enabled],StartTime,StopTime,[AvgRunTime],[LastRunTime],RunTimeStatus,LastRunOutcome) 
...
BEGIN
	...
	SELECT @QueryValue = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue' AND AlertName = 'CPUAlert' AND [Enabled] = 1

	SELECT @QueryValue2 = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue2' AND AlertName = 'CPUAlert' AND [Enabled] = 1
...
BEGIN
	...
	SELECT @QueryValue = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue' AND AlertName = 'LongRunningJobs' AND [Enabled] = 1

	SELECT @QueryValue2 = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue2' AND AlertName = 'LongRunningJobs' AND [Enabled] = 1
...
SET NOCOUNT ON
	...
	SELECT @ServerName = CONVERT(NVARCHAR(50), SERVERPROPERTY('servername'))
	SELECT @QueryValue = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue' AND AlertName = 'LongRunningQueries' AND [Enabled] = 1
	SELECT @QueryValue2 = COALESCE(CAST(Value AS INT),@QueryValue) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue2' AND AlertName = 'LongRunningQueries' AND [Enabled] = 1
	SELECT @EmailList = EmailList,
			@CellList = CellList	
	...
	IF EXISTS (SELECT * FROM #QUERYHISTORY
				...
				AND [DBName] NOT IN (SELECT [DBName] COLLATE DATABASE_DEFAULT FROM [dbWarden].dbo.DatabaseSettings WHERE LongQueryAlerts = 0)
...
BEGIN
	...
	SELECT @QueryValue = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue' AND [Enabled] = 1
			AND (@CheckTempDB = 0 AND AlertName = 'LogFiles' OR @CheckTempDB = 1 AND AlertName = 'TempDB')
	SELECT @QueryValue2 = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue2' AND [Enabled] = 1
			AND (@CheckTempDB = 0 AND AlertName = 'LogFiles' OR @CheckTempDB = 1 AND AlertName = 'TempDB')
	SELECT @MinFileSizeMB = CAST(Value AS INT) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'MinFileSizeMB' AND [Enabled] = 1
			AND (@CheckTempDB = 0 AND AlertName = 'LogFiles' OR @CheckTempDB = 1 AND AlertName = 'TempDB')
	SELECT @EmailList = EmailList,
			@CellList = CellList	
	...
	JOIN [dbWarden].dbo.FileStatsHistory t2
		...
		AND t.FileStatsID = (SELECT COALESCE(MAX(FileStatsID) -1,1) FROM [dbWarden].dbo.FileStatsHistory) 
...
BEGIN
	...
	/* LOG FILES */
	EXEC [dbWarden].dbo.usp_CheckFilesWork @CheckTempDB=0, @WarnGrowingLogFiles=1

	/* TEMP DB */
	EXEC [dbWarden].dbo.usp_CheckFilesWork @CheckTempDB=1, @WarnGrowingLogFiles=0
...
**	05/14/2013		Michael Rounds			2.4					Added AlertSettings and DatabaseSettings sections and new @ShowdbWardenSettings to turn On/Off
**																IF @ShowdbWardenSettings is enabled, will also display databases NOT listed in DatabaseSettings table
...
**																Added current version of dbWarden to the footer of the report
...
BEGIN
	...
	SELECT @ShowDatabaseSettings = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowDatabaseSettings'
	SELECT @ShowModifiedServerConfig = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowModifiedServerConfig'
	SELECT @ShowdbWardenSettings = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowdbWardenSettings'
	SELECT @ShowFullFileInfo = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowFullFileInfo'
	SELECT @ShowFullJobInfo = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowFullJobInfo'
	SELECT @ShowSchemaChanges = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowSchemaChanges'
	SELECT @ShowBackups = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowBackups'
	SELECT @ShowCPUStats = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowCPUStats'
	SELECT @ShowPerfStats = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowPerfStats'
	SELECT @ShowEmptySections = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowEmptySections'
	SELECT @ShowLogBackups = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowLogBackups'
	SELECT @ShowErrorLog = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowErrorLog'
	SELECT @ShowOrphanedUsers = COALESCE([Enabled],1) FROM [dbWarden].dbo.AlertSettings WHERE AlertName = 'HealthReport' AND VariableName = 'ShowOrphanedUsers'	
	...
	SELECT @LongQueriesQueryValue = COALESCE(CAST(Value AS INT),1) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue' AND AlertName = 'LongRunningQueries'
	SELECT @BlockingQueryValue = COALESCE(CAST(Value AS INT),1) FROM [dbWarden].dbo.AlertSettings WHERE VariableName = 'QueryValue' AND AlertName = 'BlockingAlert'
	...
	BEGIN
		...
		BEGIN
			...
			LEFT OUTER
			JOIN [dbWarden].dbo.DatabaseSettings ds
	...
	FROM [dbWarden].dbo.QueryHistory qh
	LEFT OUTER
	JOIN [dbWarden].dbo.DatabaseSettings ds
	...
	FROM [dbWarden].dbo.BlockingHistory bh
	LEFT OUTER
	JOIN [dbWarden].dbo.DatabaseSettings ds
	...
	END ELSE
	BEGIN
		IF EXISTS (SELECT * FROM [dbWarden].dbo.DatabaseSettings WHERE SchemaTracking = 1) AND @ShowEmptySections = 1
		BEGIN
			SELECT 
				@HTML = @HTML +
				'&nbsp;<div><table width="1250"> <tr><th class="header" width="1250">Schema Changes</th></tr></table></div><div>
			...
			SELECT @HTML = @HTML + '</table></div>'
		END
		IF NOT EXISTS (SELECT * FROM [dbWarden].dbo.DatabaseSettings WHERE SchemaTracking = 1) AND @ShowEmptySections = 1
		BEGIN
			SELECT 
				@HTML = @HTML +
				'&nbsp;<div><table width="1250"> <tr><th class="header" width="1250">Schema Changes</th></tr></table></div><div>
	...
	IF @ShowdbWardenSettings = 1
	BEGIN
		SELECT @HTML = @HTML +
		'&nbsp;<table width="1250"><tr><td class="master" width="700" rowspan="3">
			<div><table width="700"> <tr><th class="header" width="700">dbWarden Alert Settings</th></tr></table></div><div>
			<table width="700">
			<tr>
		...
		SELECT @HTML = @HTML + 
			'<div><table width="525"> <tr><th class="header" width="525">dbWarden Database Settings</th></tr></table></div><div>
			<table width="525">
				<tr>
				<th width="150">Database</th>
		...
		LEFT OUTER
		JOIN [dbWarden].dbo.DatabaseSettings b
		...
		SELECT
				...
				'<td width="375" bgcolor="#FFFF00" colspan="4">' + 'This database does NOT exist, but a record exists in DatabaseSettings' +'</td>' +
				 '</tr>'
		FROM [dbWarden].dbo.DatabaseSettings b
		LEFT OUTER
	...
	SELECT @HTML = @HTML + '&nbsp;<div><table width="1250"><tr><td class="master">Generated on ' + CAST(GETDATE() AS NVARCHAR) + ' with dbWarden v2.5.2' + '</td></tr></table></div>'
